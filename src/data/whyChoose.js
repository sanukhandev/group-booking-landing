import bg from "../assets/images/backgrounds/why-choose-left-bg.jpg";
import bg2 from "../assets/images/shapes/why-choose-right-map.png";

const whyChoose = {
  bg,
  bg2,
  toggleText: " Trips \n & tours",
  title: "Why Choose DesertWhales",
